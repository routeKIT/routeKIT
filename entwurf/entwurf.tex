...
\begin{itemize}
\item Es findet keine Schätzung statt, wie lange eine Vorberechnung dauern wird; stattdessen wird einfach gemeldet, dass die Vorberechnung mehrere Stunden dauern kann. (Pflichtenheft Abschnitte 9.2, 9.5)
\end{itemize}
  ...
  \class{MapManager}
        ...
        {\none}
        {
          ...
          \method{deleteMap}
                 ...
                 {
                   Löscht die ausgewählte \gls{karte} aus der internen Liste und von der Festplatte (die 2  Graphen, Daten über Beschränkungen und alle \glspl{vorberechnung}).
                 }
  ...
  \class{GraphIndex}
        ...
        {\none}
        {
	      \method{GraphIndex}
		         ...
		         {Konstruktor: Erzeugt die Datenstruktur für den gegebenen Graph und die angegebenen Zoomstufe.}	
          ...
          \method{EdgeProperties}
                 {
                   ...
                   \param{maxSpeed}{int}{Die zulässige Höchstgeschwindigkeit für diese Kante oder 0, falls nicht festgelegt.}
                 }
