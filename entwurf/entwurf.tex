...
}
{
  \class{Controller}
        ...
        {\none}
        {
          ...
          \method{selectProfile}
                 ...
                 {
                   Wählt das angegebe \gls{profil} aus.
                 }
          \method{selectMap}
                 {
                 ...
                 {
                   Wählt die angegebe \gls{karte} aus.
                 }

          \method{startPrecalculation}
                 {
                   \param{profileAndMap}{ProfileMapCombination}{Eine nicht vorberechnete Kombination aus \gls{profil} und \gls{karte}.} 
                 }
                 {
  ...
  \class{MapManagerController}
        ...
        {\none}
        {
          \method{changeMap}
                 {
                   \param{m}{StreetMap}{Die neue \gls{karte}.}
                 }
                 {
          ...
          \method{addProfile}
                 {
                   \param{p}{Profile}{Das neue \gls{profil}.}
                 }
                 {
          ...
          \method{removeProfile}
                 {
                   \param{p}{Profile}{Das \gls{profil}, das entfernt werden soll.}
                 }
                 {
...
\class{ProfileManager}
        ...
        {\none}
        {
          \method{saveProfile}
                 {
                   \param{p}{Profile}{Das \gls{profil}, das gespeichert werden soll.}
                 }
                 {
          ...
          \method{deleteProfile}
                 {
                   \param{p}{Profile}{Das \gls{profil}, das gelöscht werden soll.}
                 }
                 {
  ...
  \class{MapManager}
        ...
        {\none}
        {
          \method{saveMap}
                 {
                   \param{m}{StreetMap}{Die \gls{karte}, die gespeichert werden soll.}
                 }
                 {
          ...
          \method{deleteMap}
                 {
                   \param{m}{StreetMap}{Die \gls{karte}, die gelöscht werden soll.}
                 }
                 {
...
}
{
  ...
  \class{ArcFlagsDijkstra}
        {
          Verwended \gls{dijkstra}, um die schnellste \gls{route} zwischen Start- und Zielpunkt für die aktuelle Kombination aus \gls{karte} und \gls{profil} zu berechnen.
...
\class{Weights}
  ...
  \class{RouteModel}
        {Stellt die aktuellen Start- und Zielpunkte, sowie die aktuell berechnete \gls{route} dar. Die getter liefern dabei immer den aktuelle Zustand (auch null möglich). Die setter ändern den Wert und informieren eventuelle \reftype{RouteListener}}
        {\none}
        {
  ...
  \class{EdgeBasedGraph}
        {
          ...
          Diese Datenstruktur ist profilunabhängig und wird, wie \reftype{Graph}, bei der \gls{vorberechnung} für eine \gls{karte} erstellt.
          Erst in Kombination mit den \gls{profil}-spezifischen \reftype{Weights} kann sie zur Routenberechnung verwendet werden.
        }
        {\none}
        {
