        ...
        {\none}
        {
          ...
          \method{onStartAndDestChanged}
                 ...
                 }
                 {
                   ...
                   Die gleichen Aktionen wie für \refmethod{MainController}{onStartChanged} und \refmethod{MainController}{onDestinationChanged} werden ausgeführt, nur nicht doppelt.
                 }
