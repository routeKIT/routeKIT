  	...
  	\class{PreCalculator}
        ...
        {\keine}
        {
          \method{doPrecalculation}
                 ...
                 {Führt die Vorberechnung für die gegebene Kombination aus \refclass{Profile}[Profil] und \refclass{StreetMap}[Karte] durch. Dabei werden ein \refclass{EdgeWeighter}[EdgeWeighter] und ein \refclass{ArcFlagsCalculator}[ArcFlagsCalculator] aufgerufen.}
        }
  \class{MapImporter}
