...
}
{
  ...
  \class{Route}
        ...
        {
          \attr{start}{\refclass{PointOnEdge}}{Der Startpunkt der Route.}
          \attr{destination}{\refclass{PointOnEdge}}{Der Zielpunkt der Route.}
        }
        {
          ...
          \method{getNodeIterator}[Iterator<Node>]
                 {\none}
                 {Gibt einen Iterator über die Knoten der Route zurück.}
        }
