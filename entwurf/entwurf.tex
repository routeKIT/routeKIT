...
\newcommand{\attr}[3]{
  \item[\namedlabel{A:\currentclass.#1}{#1}] #3 Typ:~\code{#2}
}
% Argumente:
% 1. Name
...
\item Die folgenden Typen aus dem Klassendiagramm sind „typedefs“, keine echten Klassen:
  ...
  \item \code{Weight}: \code{int}, das positive Gewicht der Kante (wobei leichtere Kanten bevorzugt werden)
	...
	\method{getEdgesIn}[Edge[]]
		{
		    ...
		    {Bestimmt alle Kanten in einem Kartenausschnitt, der durch \refparam{GraphIndex}{getEdgesIn}{leftTop} und \refparam{GraphIndex}{getEdgesIn}{rightBottom} festgelegt ist. Die Methode gibt ein Array von Kanten Id's zurück.}
          ...
          \method{fromSmt}[Coordinates]
                 {
                   ...
                   \param{zoom}{float}{Die \gls{smt}-Zoom-Komponente.}
                 }
                 {
                   Statische Methode.
        ...
        {\keine}
        {
          ...
          \method{getTile}[BufferedImage]
                 ...
                 }
                 {
                   ...
                   andernfalls wird eine Dummy-Kachel zurückgegeben und die richtige von \refparam{TileCache}{TileCache}{target}[target] angefordert, im Zwischenspeicher gespeichert und dann zurückgegeben. Kacheln von tieferer Zoomstufe und der Umgebung einer Kachel werden von \refparam{TileCache}{TileCache}{target}[target] angefordert und im Zwischenspeicher gespeichert.
                 }
          \method{deleteTiles}
        ...
        {\keine}
        {
          ...
          \method{deleteProfile}
                 {\keine}
                 {
                   ...
                   Beachte: Das Profil wird erst in \refmethod{ProfileManagerController}{saveAllChanges}[saveAllChanges] tatsächlich gelöscht.
        ...
        {\keine}
        {
          ...
          \method{deleteCurrentMap} % TODO inkonsistenter name: beim profil ohne „curren“
                 {\keine}
                 {
                   ...
                   Beachte: Die Karte wird erst in \refmethod{MapManagerController}{saveAllChanges}[saveAllChanges] tatsächlich gelöscht.
