...
}
{
        ...
        {\none}
        {
          \method{Controller}
                 {\none}
                 {
                   ...
                   Für den genauen Ablauf siehe Abbildung \ref{fig:sequenz_start}.
                 }
  ...
  \class{ProfileManagerController}
	  ...
	  Ein Beispiel für die Kommunikation zwischen den beiden Klassen ist in Abbildung \ref{fig:sequenz_profilVerwaltung} zu sehen.
        }
        {\none}
        {
...
\package{MapDisplay}{
  ...
  Ein beispielhafter Ablauf ist in Abbildung \ref{fig:sequenz_rendern} zu sehen.
