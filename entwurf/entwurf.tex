...
}
{
  ...
  \class{OSMWay}
        ...
        {\none}
        {
          \method{OSMWay}
                 {
                   \param{properties}{Map<String, String>}{Eine Liste von OSM-Tags.}
                 }
  ...
  \class{MapEdge}
        ...
        }
        {
          \method{MapEdge}
                 {
                   \param{targetNode}{int}{Die ID des Zielknotens.}
...
}
{
  ...
  \class{WeightRestriction}
        ...
        {\none}
        {
          \method{getInstance}[Restriction]
                 {
                   \param{maxWeight}{int}{Das maximale Fahrzeuggewicht.}
                 }
                 {Gibt eine Instanz dieser Klasse für den angegebenen Wert zurück.}
        }
  \class{WidthTypeRestriction}
        {Repräsentiert eine Beschränkung der Fahrzeugbreite.}
        {\none}
        {
          \method{getInstance}[Restriction]
                 {
                   \param{maxWidth}{int}{Die maximale Fahrzeugbreite.}
                 }
                 {Gibt eine Instanz dieser Klasse für den angegebenen Wert zurück.}
        }
  \class{HeightTypeRestriction}
        {Repräsentiert eine Beschränkung der Fahrzeughöhe.}
        {\none}
        {
          \method{getInstance}[Restriction]
                 {
                   \param{maxHeight}{int}{Die maximale Fahrzeughöhe.}
                 }
                 {Gibt eine Instanz dieser Klasse für den angegebenen Wert zurück.}
        }
