...
\newcommand{\attr}[3]{
  \item[\namedlabel{\@attrlabel{\currentclass}{#1}}{\code{#1}}] #3 Typ:~\code{#2}
}
% Argumente:
% 1. Name
...
% 3. kurze Beschreibung
\newcommand{\param}[3]{
  \item[\namedlabel{\@paramlabel{\currentclass}{\currentmethod}{#1}}{\code{#1}}] #3 Typ:~\code{#2}
}
...
\NewDocumentCommand{\refclass}{mO{#1}}{
  \hyperref[\@classlabel{#1}]{\code{#2}}\xspace%
}
% Argumente:
% 1. Klasse
% 2. Attribut
