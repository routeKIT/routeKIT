  ...
  \class{Controller}
        ...
        {\none}
        {
          ...
          \method{Precalculate}
                 ...
                 {
                   Ruft \refmethod{PreCalculatorr}{doPrecalculation} auf, falls keine Vorberechnung für diese Kombination aus Profil und Karte existiert.
                 }
...
{
  \class{MapImporter}
        {Liest eine OSM-Karte aus dem Dateisystem in ein \reftype{Graph}-Objekt}
        {\none}
        {
          \method{importMap}[StreetMap]
                 ...
                 {Importiert und säubert den Straßengraph. Erzeugt das Adjazenzfeld und den kantenbasierten Graphen aus \reftype{MapNode}.}
        }
  \class{OSMParser}
        ...
        {\none}
        {
          \method{parseOSM}[Graph]
                 ...
                 {Wandelt eine OSM-Karte in eine verlinkte Datenstruktur \reftype{MapNode} um.}
        }
  \class{MapNode}
  ...
  \class{ArcFlagsCalculator}
        ...
        {\none}
        {
          \method{calculateArcFlags}
                 ...
                 {
                   Berechnet die Arc-Flags für die angegebene Kombination und setzt die \reftype{ArcFlags} von \refparam{ArcFlagsCalculator}{calculateArcFlags}{combination} entsprechend.
                 }
        }
}
          ...
          \method{generateRouteDescription}[RouteDescription]
                 {
                   ...
                   \param{data}{ProfileMapCombination}{Der Graph der zur Generierung der Beschreibung verwendet wird.}
                 }
...
}
{
  ...
  \class{MapView}
        ...
        {\none}
        {
          \method{MapView}
                 {
                   \param{s}{TileSource}{eine gerenderte Kachel}
                 }
                 {Ein Konstruktor, der ein Objekt der Klasse \reftype{MapView} erzeugt.}
          \method{paint}
                 {
                   \param{graphics}{Graphics}{ein Objekt vom}
                 }
                 {Zeichnet einen Kartenausschnitt, indem fertige Kacheln richtig platziert werden. Bestimmt dazu alle Kacheln, die in der aktuellen Ansicht benötigt werden.}
        }
...
}
{
  ...
  \class{ProfileMapCombination}
	...
	\method{isCalculated}[boolean]
         	    {\none}
	    {Gibt \code{true} zurück, wenn für eine Kombination aus Profil und Karte eine Vorberechnung der Gewichte und der Arc-Flags existiert.}
         }
  \class{ArcFlags}
