  ...
  \class{MainController}
        ...
        {\none}
        {
          \method{MainController}
                 {\none}
                 {
                   Erstellt den Controller, lädt \glspl{profil}, die Namen der \glspl{karte} und die aktuelle \gls{karte} vollständig und erstellt dann die \reftype{MainView}.
  ...
  \class{OSMWay}
        ...
        {\none}
        {
          \method{OSMWay}
                 ...
                 {Konstrukor: Erzeugt ein neues Objekt aus den angegebenen OSM-Tags.}
          ...
          \method{getRestriction}[Restriction]
                 {\none}
                 {Liefert ein \reftype{Restriction}-Objekt mit den Beschränkungen des Wegs.}
        }
  \class{MapEdge}
  ...
  \class{VehicleTypeRestriction}
        ...
        {\none}
        {
          \method{getInstance}[Restriction]
                 ...
                 {Gibt eine Instanz dieser Klasse für den angegebenen Fahrzeugtyp zurück.}
        }
  \class{WeightRestriction}
        ...
        {\none}
        {
          \method{getInstance}[Restriction]
                 ...
                 {Gibt eine Instanz dieser Klasse für den angegebenen Wert zurück.}
        }
