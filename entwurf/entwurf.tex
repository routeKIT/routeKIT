...
% 4. Beschreibung
\NewDocumentCommand{\method}{m O{void} m +m}{ % the ‘+m’ means that parameter 4 can contain several paragraphs, see http://tex.stackexchange.com/questions/64328/blank-lines-break-xparse-or-ifthen-macro
          ...
          \method{allowsTurn}[boolean]
                 {
                   ...
                   \param{profile}{\refclass{Profile}}{Das \gls{profil}, für das die Gültigkeit der Route bestimmt werden soll.}
                 }
                 {
                   Bestimmt, ob eine \gls{route}, die den Knoten über die angegebenen Kanten betritt und verlässt, gültig ist.
  ...
  \class{EdgeProperties}
        ...
        {\keine}
        {
          ...
          \method{allowsRoute}[boolean]
                 ...
                 {Bestimmt, ob eine \gls{route}, die über diese Kante führt, gültig ist.}
