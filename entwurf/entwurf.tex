...
\package{MapDisplay}{
        ...
        {\keine}
        {
          \method{tileFinished}{void}
                 ...
                 }
                 {
                   ...
                   Die übliche Aktion ist, ein \code{repaint} der Kartenansicht auszulösen.
                 }
        }
  \class{TileSource}
        {Abstrakte Klasse, die ein Interface für die (synchrone) Berechnung von Kartenkacheln definiert.}
        {\keine}
        {
  ...
  \class{OSMRenderer}
        {Eine \refclass{TileSource}, die die Kacheln vom OpenStreetMap-Server herunterlädt.}
        {\keine}
        {
          \method{getTile}{BufferedImage}
                 {
