...
\package{Precalculation}{
  \class{PreCalculator}
        {Führt die Berechnung der Arcflags durch.}
        {\keine}
        {
          \method{doPrecalculation}
                 {
                   \param{comb}{ProfileMapCombination}{Die Kombination aus Profil und \refclass{Map}[Karte], für die Arcflags vorberechnet werden sollen}
                 }
                 {Berechnet Arcflags für die gegebene Kombination.}
        }
  \class{MapImporter}
...
\package{Controllers}{
 ...
 \class{Controller}
        ...
        {\keine}
        {
                ...
                {
	            \param{}{Profile}{Das aktuelle Profil.} 
	      }
                {Wählt das aktuelle Profil aus.}

                \method{selectMap}
                {
	            \param{}{Map}{Die aktuelle Karte.} 
	      }
                {Wählt die aktuelle Karte aus.}

                \method{schedulePrecalculate}
                {
                     \param{}{ProfileMapCombination}{Eine nicht vorberechnete Kombination aus Profil und Karte.} 
                }
