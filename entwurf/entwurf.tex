...
\class{Weights}
  ...
  \class{RouteModel}
        {Stellt die aktuellen Start- und Zielpunkte, sowie die aktuell berechnete \gls{route} dar. Die getter liefern dabei immer den aktuellen Zustand (auch null möglich). Die setter ändern den Wert und informieren eventuelle \reftype{RouteListener}}
        {\none}
        {
