...
\package{Map}{}
{
  ...
  \class{IntArraySet}{Neue Klasse. Ist ein \code{java.util.Set<Integer>} das aus einem Interval eines int-arrays}
        {\none}
        {
        \method{IntArraySet}
        {\param{base}{int}{Eine ID der Kante.}
        \param{count}{int}{Eine ID der Kante.}
        \param{data}{int[]}{Eine ID der Kante.}}
