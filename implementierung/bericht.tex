...
\item \bug{Die Anwendung braucht lang zum Starten.}
{\code{GraphIndex}e und Navigationsarrays im Graphen werden beim Starten neu aufgebaut}
{Mehr Daten auf die Festplatte schreiben und beim /tart laden.}
\item \bug{Die Ansicht ist nich dem Wechseln der Karte möglicherweise nicht über Kanten.}
...
{das steht so im Programmcode, es ist keine Bedingung vorhanden.}
