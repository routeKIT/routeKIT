...
\begin{enumerate}
\item Für große Karten ist das Rendern der Kacheln zu langsam. Eine mögliche Lösung wäre es, einen Vergröberunsalgorithmus zu realisieren.
\item Lange Wartezeit beim Start der Anwendung. Mögliche Lösung wäre es, sämtliche Graph-Indizes abzuspeichern und danach zu laden. Dadurch werden sie nicht mehr jedes Mal dynamisch aufgebaut.
\item Jede Karte wird zunächst auf bestimmte Koordinaten in Karlsruhe zentriert.
\item Die Nachricht „Sie haben ihr Ziel erreicht.“ wird bei jeder Wegbeschreibung ausgegeben, auch wenn keine Route gefunden wurde.
\item Die Nachricht „Es wurde keine Route gefunden.“ wird niemals ausgeben.
\end{enumerate}
