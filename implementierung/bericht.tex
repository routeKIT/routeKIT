...
\begin{enumerate}
\item Für große Karten ist das Rendern der Kacheln zu langsam. Mögliche Lösung wäre einen Vergröberunsalgorithmus zu realisieren.
\item Lange Wartezeit beim Start der Anwendung. Mögliche Lösung wäre sämtliche Graph-Indizes abzuspeichern und danach zu laden. Dadurch werden sie nicht mehr jedes mal dynamisch aufgebaut.
\item Jede Karte wird erstmal auf bestimmte Koordinaten in Karlsruhe zentriert.
\item Nachricht „Sie haben ihr Ziel erreicht.“ wird bei jeder Wegbeschreibung ausgegeben.
\item Nachricht „Es wurde keine Route gefunden.“ wird niemals ausgeben.
\end{enumerate}
