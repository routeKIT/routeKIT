...
Linie. Dieses Verfahren kann verwendet werden, um die Koordinaten eines \reftype{PointOnEdge} zu bestimmen.}
  ...
  \class{FileUtil}
        {
          Neue Klasse. Erhält verschiedene statische Methoden, welche etwas mit Dateien oder Dateisystemen zu tun haben.
        }
        {\none}
        {
          \method{rmRf}
  ...
  \class{TimeUtil}
        {
          Neue Klasse. Enthält eine Methode, welche etwas mit Zeit zu tun hat.
        }
        {\none}
        {
