...
\test{graphIndex}{GraphIndex}{
  Es werden beide GraphIndex-Implementierungen (Array- und Tree-) getestet. Dazu werden sie mit demselben Graphen (einem Gitter aus unverbundenen Straßenstücken) initialisiert.
...
\test{routeModel}{RouteModel}{
  Es wird das Beobachtermuster der RouteModel-Klasse getestet. Dazu wird überprüft, ob in verschiedenen Situationen Events an alle Listener ausgegeben wird, indem ein Testlistener registriert wird und verschiedene Änderungen an den Daten durchgeführt werden.
}{
...
\test{osmParser}{OSMParser}{
  ...
  alle gültigen Strukturen korrekt in den Graph übernommen werden und ungültige Karten vom Programm erkannt werden und der Import abgebrochen wird.
}{bestanden}
...
\test{coords}{Coordinates}{
  ...
  distanceTo und angleBetween die erwarteten Werte zurückgeben und eine Transformation und Rücktransformation mit den Konvertierungsmethoden die Testkoordinaten unverändert lässt.
}{bestanden}
