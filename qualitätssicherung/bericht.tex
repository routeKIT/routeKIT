...
\test{graphIndex}{GraphIndex}
     {Es werden beide \code{GraphIndex}-Implementierungen (\code{Array}- und \mbox{\code{Tree}-)} getestet. Dazu werden sie mit demselben Graphen (einem Gitter aus unverbundenen Straßenstücken) initialisiert.
