...
\test{routeModel}{RouteModel}{
  Es wird das Beobachtermuster der RouteModel-Klasse getestet. Dazu wird überprüft, ob in verschiedenen Situationen Events an alle Listener ausgegeben wird, indem ein Testlistener registriert wird und verschiedene Änderungen an den Daten durchgeführt.
}{
