...
\endfirsthead
\rowno[start] & Start\footnote{Die Konfiguration wird neu vom Server runtergeladen. Damit wird gesichert, dass der Test mit der Karte "Regierungsbezirk Karlsruhe" und dem dafür vorberechneten Standardprofil "PKW (Standard)" gestartet wird, eigene Kacheln verwendet werden und die \gls{arc} aktiviert sind.} &/TF30/ & \cmark &  \footnote{Neustart der Anwendung} \\ \hline
\rowno[aboutopen] & Öffnung des Über-Fenster & \ref{TF:aboutviewopen}& \cmark & \footnotemark[2] \\ \hline
