...
\bug{profileNoWarning}{Profilverwaltung: Warnung bei Enter}
    ...
    {behoben}
\bug{testCLIHelp}{CLI-Hilfe Testfall}
...
\bug{currentProfileNotExisting}{Gelöschtes aktuelles Profil}
    ...
    Beim erneuten Öffnen des Hinzufügen Dialogs ist ein Standardprofil ausgewählt
    ...
    was nun ein Standardprofil ist.}
...
<<<<<<< Upstream, based on branch 'master' of https://pse.dogcraft.de/
=======
    {behoben}
\bug{centerMapProfileChange}{Kartenauschnitt zentriert bei Profilwechsel}
    ...
    {Der Kartenausschnitt wird zentriert, sobald sich die aktuelle \code{Pro\-file\-Map\-Com\-bi\-na\-tion} ändert.}
    {Den Kartenauschnitt nur zentrieren, wenn sich die aktuelle Karte ändert.}
>>>>>>> 27edcae Testdokument: kleinere Verbesserungen, Anführungszeichen
    {behoben}
\end{itemize}
