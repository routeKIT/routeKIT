...
Alle Testfälle mit kleineren Nummern wurden im Pfichtenheft beschrieben.
...
\testfall
    ...
    {Der Hinzufügen-Knopf wird gedrückt. Ein Profil wird ausgewählt und die Wahl wird drei mal bestätigt.}
...
\testfall
    {Alle Fenster außer dem Hauptfenster sind geschlossen.}
    {Der Verlauf-Knopf wird gedrückt.}
...
\testfall
    ...
    {Es werden keine \gls{arc} für die Vorberechnung verwendet.}
...
\testfall
    ...
    {Es werden \gls{arc} für die Vorberechnung verwendet.}


\end{description}

Startbedingung: Der Test wird mit der Karte "Regierungsbezirk Karlsruhe" und dem dafür vorberechneten Standardprofil "PKW (Standard)" gestartet. Eine Internetverbindung ist hergestellt. Es werden beim Start eigene Kacheln verwendet und die \gls{arc} sind aktiviert.
...
\rowno[arcs] & Aktivierung der \gls{arc} & \ref{TF:activatearcflgs} & \cmark & \ref{noarcs} und ** \\ \hline
