...
\bug{profileNoWarning}{Profilverwaltung: Warnung bei Enter}
    ...
    {Der Code, der die Warnung erzeugt, liegt im Programmcode des Knopfes und nicht in der Methode des \code{ProfileManager}, die den Dialog schließt.}
    {Den Code, der die Warnung erzeugt, in den \code{ProfileManager} verschieben.}
    {behoben}
\end{itemize}
...
\bug{routeCalcAllEdges}{Routenberechnung: alle Kanten}
    ...
    {Mehrere Datenstrukturen „lazy“ initialisieren (nicht eingefügte Kanten sind „unendlich“ weit entfernt usw.).}
    {behoben}
