...
public class Profile implements Cloneable {
	...
	/**
	 * The average speed of the vehicle on an ordinary (country) road, in kilometers per hour.
	 */
	 ...
	 * @param height The height of the vehicle, in centimeters.
	 * @param width The width of the vehicle, in centimeters.
	 * @param weight The weight of the vehicle, in kilograms.
	 * @param speedHighway The average speed of the vehicle on a highway, in kilometers per hour.
	 * @param speedRoad The average speed of the vehicle on an ordinary (country) road, in kilometers per hour.
	 */
	 ...
	 * @param speedHighway The average speed of the vehicle on a highway, in kilometers per hour.
	 * @param speedRoad The average speed of the vehicle on an ordinary (country) road, in kilometers per hour.
	 * @param isDefault If the profile is a default profile or not.
	 */
	...
	/**
	 * Saves the profile to the specified file using the Java {@link Properties} format.
	 * 
	 * @param file The file to which the profile should be saved.
	 ...
	 * 
	 * @param file The file from which the profile should be loaded.
	 ...
	 * </p><p>
	 * Default profiles are different than normal profiles in that it’s not allowed
	 * to set their values.
	 * </p>
	 * 
	 * @return {@code true} if the profile is a default profile, else {@code false}.
	 */
	 ...
	 * Note that this is not allowed for {@link #isDefault() default} profiles.
	 * </p>
	 * @param name The type of the vehicle.
	 */
	 ...
	 * Note that this is not allowed for {@link #isDefault() default} profiles.
	 * </p>
	 * @param name The height of the vehicle, in centimeters.
	 */
	 ...
	 * Note that this is not allowed for {@link #isDefault() default} profiles.
	 * </p>
	 * @param name The width of the vehicle, in centimeters.
	 */
	 ...
	 * Note that this is not allowed for {@link #isDefault() default} profiles.
	 * </p>
	 * @param name The weight of the vehicle, in kilograms.
	 */
	...
	/**
	 * Gets the average speed of the vehicle on a highway, in kilometers per hour.
	 * @return The average speed of the vehicle on a highway, in kilometers per hour.
	 */
	...
	/**
	 * <p>
	 * Sets the average speed of the vehicle on a highway, in kilometers per hour.
	 * </p><p>
	 * Note that this is not allowed for {@link #isDefault() default} profiles.
	 * </p>
	 * @param name The average speed of the vehicle on a highway, in kilometers per hour.
	 */
	...
	/**
	 * Gets the average speed of the vehicle on an ordinary (country) road, in kilometers per hour.
	 * @return The average speed of the vehicle on an ordinary (country) road, in kilometers per hour.
	 */
	...
	/**
	 * <p>
	 * Sets the average speed of the vehicle on an ordinary (country) road, in kilometers per hour.
	 * </p><p>
	 * Note that this is not allowed for {@link #isDefault() default} profiles.
	 * </p>
	 * @param name The average speed of the vehicle on an ordinary (country) road, in kilometers per hour.
	 */
	...
	/**
	 * Indicates whether this profile is equal to the given object.
	 * If {@code obj} is a {@code Profile}, then this is equivalent to
	 * <code>equals(obj, true)</code>, i.&nbsp;e. the profiles must be
	 * either both {@link #isDefault() default} or both non-default.
	 * @return {@code true} if the two profiles are equal, {@code false} otherwise.
	 ...
	 * @param checkDefault Whether to include the {@link #isDefault() default} property in the check or not.
	 *                     For example, <code>defaultCar.equals(defaultCar.clone(), true)</code> is {@code false}
	 *                     because the {@link #clone() clone} isn’t a default profile, but
	 *                     <code>defaultCar.equals(defaultCar.clone(), false)</code> is {@code true}.
	 * @return {@code true} if the two profiles are equal, {@code false} otherwise.
	 */
