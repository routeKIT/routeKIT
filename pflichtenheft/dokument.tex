...
% DO NOT USE - to be replaced by \counteditem
...
% will be renamed to \oitem soon
\makeatletter
\newcommand{\counteditem}[2]{
  % define the counter
...
\begin{description}
\oitem{F140} Neues Profil anlegen
\oitem{F150} Vorhandenes Profil löschen
\oitem{F160} Vorhandenes Profil ändern
\end{description}
...
\oitem{D70} % Betreuer: aufsplitten
