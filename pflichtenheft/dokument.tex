...
\item \glspl{profil}-Button: Starte Profilverwaltung, siehe Abbildung \ref{fig:mockupprofilverwaltung} ; daneben wird das aktuell ausgewäjlte Profil angezeigt
...
\item \gls{history}-Button: erlaubt Zugriff auf die \gls{history}
...
\item Unterpunkt "Über...": Zeigt Informationsfenster, siehe \ref{mockupabout}
%TODO About-Dialog
\item Unterpunkt "Beenden": Beendet das Programm
\item Menüßunkt "Export"
