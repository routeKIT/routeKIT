...
\oitem{F}{mercator}
Berechnung der Mercatorprojektion zu Geokoordinaten und andersrum
\oitem{F}{berechneAbstand}
Berechnen des realen Abstands (in km) zwischen 2 Geokoordinaten.
\oitem{F}{zeitSchaetzen}
Schätzen der benötigten Zeit für ein Wegstück unter Berücksichtigung des \glslink{profil}{Profils}, der Ampeln, der Abbiegezeiten und des Straßentyps.
\end{description}
