...
\oitem{MK}{karteRendern} Für die Kartenansicht (\ref{karteAnzeigen}) werden eigene Kartenkacheln mit aus den Straßendaten \glslink{rendern}{gerendert}.
...
\oitem{WK}{standardprofil} Es gibt ein \gls{standardprofil} für \glspl{pkw} sowie eines für \glspl{lkw}.
...
\oitem{WF}{waehleProfil} Auswahl eines aktuellen Profils für die Routenberechnung
...
\oitem{WF}{aendereKarte} aktualisieren einer vorhandenen Karte
\oitem{WF}{waehleKarte} auswahl einer aktuellen Karte für die Routenberechnung
\oitem{WF}{berechneKarte} ausführen der Berechnungen für alle Profile auf einer Karte
% Betreuer2: Answählen (gemacht)
\end{description}
...
\oitem{TF}{systemstart}\testfall
    ...
    {Es wird die zuletzt ausgewählte Karte und das zuletzt ausgewählte Profil geladen (wenn keine Karte bzw. Profil ausgewählt wurden wird die mitgelieferte Standard-Karte bzw. das mitgelieferte Standard-Profil für ein Auto geladen). Die Karte wird ohne eine berechnete Route darauf angezeigt.}
% Betreuer2: Beenden und neu starten.
\oitem{TF}{exitstart}\testfall
    {Das Programm wurde beendet}
    {Das Programm wird gestartet}
    {Es wird die zuletzt ausgewählte Karte und das zuletzt ausgewählte Profil, sowie die History geladen. Die Karte wird ohne eine berechnete Route darauf angezeigt.}
