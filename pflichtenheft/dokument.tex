...
\oitem{NF}{mausklicks} Wenn der Kartenausschnitt richtig gewählt ist, braucht die Auswahl vom Start- bzw. Zielpunkt mindestens 2 Mausklicks.
\oitem{NF}{kachelnrendern} Das Rendern einer Kachel benötigt unter 500 ms. 
\oitem{NF}{benutzbarkeit} Die öfter verwendeten Funktionen sind leichter erreichbar, als die selten verwendete.
