...
\begin{enumerate}
\item \ref{F20} (Berechnung der Route) ist schneller als fünf Sekunden.
\item \ref{F10} benötigt höchstens 500 ms.
\item Die Software muss Daten mit mindestens x Knoten und y Ways verarbeiten können.
\end{enumerate}
% Dominic
