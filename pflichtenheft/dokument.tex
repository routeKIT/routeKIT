...
\newglossaryentry{standardkarte}{
  name={Standardkarte},
  description={Eine vorinstallierte und für die Standardprofile bereits vorberechnete Karte von Karlsruhe},
...
\oitem{WK}{standardkarte} Eine Standardkarte von Karlsruhe, die  nicht gelöscht werden kann, wird mitgeliefert.
...
\testfall
    ...
    {Es wird die zuletzt ausgewählte Karte und das zuletzt ausgewählte \gls{profil} geladen (beim ersten Programmstart wird die mitgelieferte Standardkarte bzw. das mitgelieferte \gls{standardprofil} für PKWs geladen). Die Karte wird ohne Start- und Zielpunkte und eine berechnete \gls{route} angezeigt.}
...
\testfall[\ref{WK:ungueltigeEingabe}]
    ...
    {Es erscheint eine Fehlermeldun.}
...
Vorbedingung: Computer hat eine Internetverbindung. Es werden keine  \glspl{osmkachel} verwendet. Die Profile „Mein PKW“ und „MeinLKW” sowie die Karte Hamburg existieren.
