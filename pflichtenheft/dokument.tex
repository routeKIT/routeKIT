...
\newglossaryentry{verlauf}{
  name={Verlauf},
  description={Speicherung von Anfragen für spätere Wiederverwendung. Es exestiert nur ein Verlauf für die gesamte Anwendung.}
}
...
%TODO Zeiten ändern (Zeitpunkt der Berechnung)
\begin{figure}[H]
\centering
