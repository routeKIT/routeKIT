...
Das GUI Element, das Kartenkacheln dynamisch \gls{rendern} lässt, cacht und an der richtigen Position im Fenster anzeigt. Realisiert u.\,a \ref{MK:karteAnzeigen}, \ref{MK:karteVerschieben}, \ref{MK:karteZoomen}, \ref{MK:startZielZeigen}, \ref{MK:routeAnzeigen}
...
\testfall
    [\ref{WK:verlauf}]
    {Eine \gls{route} wurde bereits berechnet, die Route wird nicht angezeigt}
    {Die \gls{route} wird aus dem \gls{verlauf} geladen}
    {Die abgespeicherte \gls{route} wird angezeigt}
...
\begin{itemize}
\item Das Programm \routeKIT wird gestartet. Eine Karte von Karlsruhe (\abbildung{mockupscreenshotmain}) wird angezeigt.
\item Das \gls{profil} „PKW [default]“ wird gewählt.
\item Die Karte wird verschoben und gezoomt, indem der Benutzer die linke Maustaste zieht und die Zoomknöpfe benutzt. Die Kartenansicht ändert sich entsprechend.
