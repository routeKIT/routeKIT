...
\oitem{WF}{saveHist}
Hinzufügen einer Routenanfrage zur \gls{history}
\oitem{WF}{getHist}
Start- und Zielpunkt aus der \gls{history} auswählen
\end{description}
...
%TODO %FIXME Lieber "Verlauf" anstatt "History"?
...
% Betreuer2: History,
%TODO  Menu, Profil/Kartenknopf ins Label integrieren (gamacht)
...
\item Unterpunkt "Über...": Zeigt Informationsfenster, siehe \ref{fig:mockupabout} % TODO der mockup fehlt noch! (gemacht)
