...
\testfall
    ...
    {Es wird die zuletzt ausgewählte Karte und das zuletzt ausgewählte \gls{profil} geladen (beim ersten Programmstart wird die mitgelieferte \gls{standardkarte} bzw. das mitgelieferte \gls{standardprofil} für PKWs geladen). Die Karte wird ohne Start- und Zielpunkte und eine berechnete \gls{route} angezeigt.}
...
\testfall
    {Karte ist sichtbar, aktuelles \gls{profil} ist nicht \glslink{vorberechnung}{vorberechnet} (für die aktuelle Karte)}
    {Versuch, Start- bzw. Zielpunkt auszuwählen}
...
\testfall[\ref{WK:ungueltigeEingabe}]
    {Karte ist sichtbar, \gls{profil} ist \glslink{vorberechnung}{vorberechnet} (für die aktuelle Karte)}
    {Ein Start- oder Zielpunkt außerhalb der Karte angegeben.}
...
\testfall[\ref{WK:osmKacheln}]
    ...
    {Wechseln der Darstellungsart auf \glspl{osmkachel}}
...
\testfall[\ref{MK:karteAnzeigen}, \ref{MK:karteRendern}]
    ...
    {Wechseln der Darstellungsart auf „eigene Kacheln“}
