...
Das GUI Element, das Kartenkacheln dynamisch \gls{rendern} lässt, cacht und skaliert an der richtigen Position im Fenster anzeigt. Realisiert u.\,a \ref{MK:karteAnzeigen}, \ref{MK:karteVerschieben}, \ref{MK:karteZoomen}, \ref{MK:startZielZeigen}, \ref{MK:routeAnzeigen}
...
\item Eine Deutschlandkarte und eine Bie\-le\-feld-Karte werden importiert.
\item Die \glspl{standardprofil} werden von allen Karten entfernt, indem jede Karte ausgewählt wird und für jede Karte die \glspl{standardprofil} ausgewählt und mit dem „Entfernen“-Button entfernt werden.
...
\item Im Profilverwaltungs-Dialog werden die folgenden Profile neu angelegt:
  ...
  \end{itemize}
\item Der Profilverwaltungs-Dialog wird geschlossen.
\item Über den „Hinzufügen“-Button werden die Profile den Karten hinzugefügt:
  ...
  \end{itemize}
\item Der OK-Button wird gedrückt; es erscheint eine Zusammenfassung der Änderungen.
\item Der OK-Button wird gedrückt; die \gls{vorberechnung} startet.
\item Nachdem die Vorberechnung abgeschlossen ist, wird \routeKIT beendet.
\end{itemize}
\end{description}
