...
\title{Pflichtenheft}
\author{Kevin Birke \and Felix Dörre \and Fabian Hafner \and Lucas Werkmeister \and Dominic Ziegler \and Anastasia Zinkina}
%\date{}
...
\hyphenation{Ab-bie-ge-be-schrän-kung Ab-bie-ge-be-schrän-kun-gen Fahr-zeug Fahr-zeugs Kar-ten-aus-schnitt Kar-ten-da-ten}
...
Das Produkt ist an Autofahrer und/oder deren Mitfahrer gerichtet; es soll ihnen die Planung einer Reise erleichtern, indem es ihnen die effizienteste \gls{route} zwischen zwei eingegebenen Punkten berechnet und anzeigt.
...
\oitem{MK}{routeAnfragen} Route zwischen Start- und Zielpunkt anfragen
\oitem{MK}{routeBerechnen} Effizienteste Route zwischen Start- und Zielpunkt berechnen % TODO Gruppentreffen: Kriterien für "effizient"?
\oitem{MK}{routeAnzeigen} Effizienteste Route zwischen Start- und Zielpunkt auf der Karte anzeigen
\end{itemize}
...
\oitem{WK}{beschränkungen} Möglichst viele Beschränkungen umsetzen (Staßentyp, Abbiegebeschränkung, 
...
\oitem{AK}{fahrradFussBahn} Kein Routenplaner für Fahrrad, Fußgänger, Bahnfahrer, etc.
\oitem{AK}{app} Keine mobile App
\oitem{AK}{webapp} Keine Webanwendung
\oitem{AK}{altRoute} Keine Alternativroute sofort anzeigen
