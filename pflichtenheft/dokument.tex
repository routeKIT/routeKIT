...
\oitem{WK}{standardprofile} Es gibt zwei \gls{standardprofil}e für \glspl{pkw} und \glspl{lkw}.
...
Zwischspeichern der zuletzt gerenderten Kacheln
% TODO ?
...
\begin{description}
\oitem{WF}{neuesProfil} Anlegen eines neuen \gls{profil}s
\oitem{WF}{loescheProfil} Löschen eines vorhandenen \gls{profil}s
\oitem{WF}{aendereProfil} Ändern eines vorhandenen \gls{profil}s
\oitem{WF}{waehleProfil} Auswahl eines \gls{profil}s für die Routenberechnung
\oitem{WF}{wechsleProfil} Wechseln des ausgewählten \gls{profil}s zwischen Routenberechnungen
...
\oitem{WF}{waehleKarte} Auswählen einer Karte für die Routenberechnung
\oitem{WF}{wechsleKarte} Wechseln der ausgewählten Karte zwischen Routenberechnungen
\oitem{WF}{berechneKarte} Ausführen der \gls{vorberechnung} für alle \gls{profil}e auf einer Karte
