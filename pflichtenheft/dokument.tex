...
\oitem{WK}{routeLoeschenKarte} Bei einer Änderung der Karte wird (so weit vorhanden) eine bereits berechnete \gls{route} verworfen.
\oitem{WK}{routeNeuBerechnenProfil} Bei einer Änderung des \glslink{profil}{Profils} wird (so weit vorhanden) eine bereits berechnete \gls{route} neu berechnet.
