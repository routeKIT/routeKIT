...
\newglossaryentry{verlauf}{
  name={Verlauf},
  description={Speicherung von Anfragen für spätere Wiederverwendung. Es existiert nur ein Verlauf für die gesamte Anwendung.}
}
...
\testfall[\ref{WK:ungueltigeEingabe}]
    {Karte ist sichtbar, \gls{profil} ist \glslink{vorberechnung}{vorberechnet} (für die aktuelle Karte)}
    {Start- oder Zielpunkt wird außerhalb der Karte angegeben}
...
\testfall
    ...
    {Ein \gls{profil}, das nicht das \gls{standardprofil} ist, ist vorhanden und ausgewählt}
