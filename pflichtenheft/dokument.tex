...
\oitem{MK}{startZielWählen} Start- und Zielpunkt können ausgewählt werden. % Rechtsklick
...
\oitem{MK}{routeBerechnen} Berechnen der zeit effizientesten Route zwischen Start- und Zielpunkt
\oitem{MK}{routeAnzeigen} Anzeigen der zeit effizientesten Route  zwischen Start- und Zielpunkt auf der Karte
\end{itemize}
...
\oitem{WK}{beschränkungen} Umsetzen möglichst vieler Beschränkungen (Staßentyp, Abbiegebeschränkung, 
Maximalgewicht, Einbahnstraße) trotz Beschleunigung. Profile für die Vorberechnung. % Aufsplitten, ungenau.

\oitem{WK}{beschreibung} Wegbeschreibung anzeigen. (Bei Kreisverkehren: Ausfahrten zählen)
\oitem{WK}{history} Berechnungsanfragen speichern. History/Favoriten
\oitem{WK}{export} Export der Route.

\oitem{WK}{osmKacheln} Optional OSM-Kacheln
% Betreuer: Profile
...
\begin{itemize}
\oitem{AK}{textSuche} Keine textuelle Suche möglich
\oitem{AK}{fahrradFußBahn} Kein Routenplaner für Fahrrad, Fußgänger, Bahnfahrer oder etc.
